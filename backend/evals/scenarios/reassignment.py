...
scenario = Scenario(
    ...
    lines=[
        Line(
            "Marcus", "So I finished reviewing the staging environment setup. Looks good, Jordan."
        ),
        Line(
            "Jordan",
            "Thanks. I'm going to hand off the dashboard chart colors to Sarah since she's better with the design stuff.",
        ),
        Line(
            "Sarah",
            "Sure, I'll take that. Also the email notification templates that Marcus did are already merged and deployed.",
        ),
